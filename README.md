...
* [the-cff-table](https://github.com/Pomax/the-cff-table) ⭐ 19 | 🐛 1 | 📅 2018-04-03 - Markdown conversion of the Adobe Tech notes 5176 and 5177 about CFF.
...
* [The OpenType Cookbook](http://opentypecookbook.com) - Introduction to OpenType features for type designers. [(Source)](https://github.com/typesupply/opentype-feature-intro) ⭐ 122 | 🐛 18 | 📅 2024-02-05.
* [A bit of font generation](https://pomax.github.io/CFF-glyphlet-fonts/) - Brief excursion into OpenType.

## Assembly

* [amigafonts](https://github.com/rewtnull/amigafonts) ⭐ 369 | 🐛 3 | 📅 2020-02-05 - Faithfully remade multi platform Amiga fonts in Amiga aspect.
* [Fontraption](https://github.com/viler-int10h/Fontraption) ⭐ 121 | 🐛 4 | 🌐 Assembly | 📅 2024-09-07 - A tiny but powerful VGA text mode font editor for DOS.
...
* [CGA-font-compare](https://github.com/viler-int10h/CGA-font-compare) ⭐ 8 | 🐛 0 | 🌐 Assembly | 📅 2022-11-18 - DOS tool to check if your CGA card uses the same ROM font as the original IBM CGA.
* [x86-Assembly-Font-Renderer](https://github.com/mchlmmc/x86-Assembly-Font-Renderer) ⭐ 6 | 🐛 0 | 🌐 Assembly | 📅 2018-06-12 - Bootloader that draws characters from a 5x7px font.
* [Atari-Font-To-Code](https://github.com/kenjennings/Atari-Font-To-Code) ⭐ 4 | 🐛 0 | 🌐 C | 📅 2017-08-26 - An over-engineered Linux tool to convert an Atari 8-bit font to BASIC, C, and Assembly source.
* [x86-Assembly-Fonts](https://github.com/ArTicZera/x86-Assembly-Fonts) ⭐ 2 | 🐛 0 | 🌐 Assembly | 📅 2024-03-22 - Use different bitmap fonts in your Real Mode OS using bitmaps and pixel routines.
* [xfnt](https://github.com/hexagonix/xfnt) ⭐ 2 | 🐛 0 | 🌐 Assembly | 📅 2026-08-14 - Fontes gráficas para Hexagon/Hexagon graphic fonts.
...
* [Crimson Pro](https://github.com/Fonthausen/CrimsonPro) ⭐ 337 | 🐛 0 | 🌐 Shell | 📅 2026-06-03 - The Crimson Text typeface.
...
* [stb\_truetype](https://github.com/nothings/stb/) ⭐ 34,397 | 🐛 418 | 🌐 C | 📅 2026-08-02 - Parse, decode, and rasterize characters for TrueType fonts. Single header file.
* [sway](https://codeberg.org/dnkl/sway) - This is a fork of <https://github.com/swaywm/sway> ⭐ 17,231 | 🐛 1,378 | 🌐 C | 📅 2026-07-31 that replaces pango with <https://codeberg.org/dnkl/fcft> for font rendering.
...
* [Slug](https://github.com/EricLengyel/Slug) ⭐ 1,500 | 🐛 0 | 🌐 HLSL | 📅 2026-04-15 - Reference code for the Slug Algorithm.
* [AFDKO](https://github.com/adobe-type-tools/afdko) ⭐ 1,174 | 🐛 213 | 🌐 PostScript | 📅 2026-07-10 - Adobe Font Development Kit for OpenType. See [AFDKO Overview](https://www.adobe.com/devnet/opentype/afdko/topic_overview.html).
* [otfcc](https://github.com/caryll/otfcc) ⚠️ Archived - Parses & writes SFNT structures.
* [picasso](https://github.com/onecoolx/picasso) ⭐ 377 | 🐛 0 | 🌐 C++ | 📅 2026-07-21 - High quality 2D vector graphic rendering library. It support path , matrix , gradient , pattern , image and truetype font.
* [Raqm](https://github.com/HOST-Oman/libraqm) ⭐ 330 | 🐛 6 | 🌐 C | 📅 2026-07-23 - Library for complex text layout.
* [ttf2mesh](https://github.com/fetisov/ttf2mesh) ⭐ 230 | 🐛 12 | 🌐 C++ | 📅 2024-06-26 - Standalone library for TrueType font tessellation. Allows to load ttf-file and convert its glyphs to 2D or 3D mesh objects without rasterization.
* [SheenBidi](https://github.com/mta452/SheenBidi) ⭐ 215 | 🐛 4 | 🌐 C | 📅 2026-08-01 - World's most sophisticated implementation of latest unicode bidirectional algorithm.
* [Sluggish](https://github.com/mightycow/Sluggish) ⭐ 197 | 🐛 0 | 🌐 C | 📅 2026-03-17 - Toy CPU and GPU implementations of the Slug rendering algorithm.
* [sfntly](https://github.com/rillig/sfntly) ⭐ 178 | 🐛 6 | 🌐 Java | 📅 2022-01-27 - A Library for Using, Editing, and Creating SFNT-based Fonts.
* [slughorn](https://github.com/AlphaPixel/slughorn) ⭐ 145 | 🐛 1 | 🌐 C++ | 📅 2026-08-13 - Library for shoehorning the Slug text/graphics GPU rendering library into projects.
...
* [osgSlug](https://github.com/AlphaPixel/osgSlug) ⭐ 9 | 🐛 1 | 🌐 C++ | 📅 2026-08-13 - Slug support for OpenSceneGraph via SlugHorn
...
* [WOFF2](https://github.com/google/woff2) ⭐ 1,814 | 🐛 91 | 🌐 C++ | 📅 2026-06-29
...
* [font to svg](https://github.com/donbright/font_to_svg) ⭐ 268 | 🐛 2 | 🌐 C++ | 📅 2022-11-21 - Render characters from font files into an SVG path.
* [Text rendering tests](https://github.com/unicode-org/text-rendering-tests) ⭐ 185 | 🐛 18 | 🌐 HTML | 📅 2025-06-30 - Test suite for text rendering.
* [LCDF Typetools](https://github.com/kohler/lcdf-typetools) ⭐ 169 | 🐛 5 | 🌐 C++ | 📅 2025-05-08 - Utilities for manipulating OpenType, PostScript Type 1, and Multiple Master fonts.
...
* [ascii-art](https://github.com/codewithnick/ascii-art) ⭐ 94 | 🐛 23 | 🌐 C++ | 📅 2025-01-29 - A C++ library to make everyday alphabets look much better on the terminal , this project uses OOPS concepts to make unique fonts and display letters on command line.
* [stb-truetype-opengl-examples](https://github.com/0xc0dec/demos) ⭐ 48 | 🐛 0 | 🌐 C++ | 📅 2026-03-31 - Examples of TrueType font rendering in C++11 using stb\_truetype library and OpenGL 3+.
* [trex](https://github.com/KyrietS/trex) ⭐ 38 | 🐛 3 | 🌐 C++ | 📅 2025-07-27 - Font rendering, atlas generation and text shaping library written in C++.
* [artery-font-format](https://github.com/Chlumsky/artery-font-format) ⭐ 36 | 🐛 0 | 🌐 C++ | 📅 2024-06-30 - Artery Atlas Font format library.
* [DigiFont](https://github.com/cbm80amiga/DigiFont) ⭐ 30 | 🐛 0 | 🌐 C++ | 📅 2024-09-09 - Library for nice, scalable digit rendering using any Arduino GFX libraries.
...
* [vectorfontstorm](https://github.com/VoxelStorm-Ltd/vectorfontstorm) ⭐ 2 | 🐛 0 | 🌐 C++ | 📅 2026-04-10 - C++ vector font rendering library for OpenGL 3D text rendering, by VoxelStorm Resources.
...
* [Typography](https://github.com/LayoutFarm/Typography) ⭐ 455 | 🐛 35 | 🌐 C# | 📅 2023-09-18 - C# Font Reader (TrueType / OpenType / OpenFont), Glyphs Layout and Rendering.
* [SixLabors.Fonts](https://github.com/SixLabors/Fonts) ⭐ 347 | 🐛 1 | 🌐 C# | 📅 2026-08-11 - Font loading and drawing library.
...
* [font-kit](https://github.com/servo/font-kit) ⭐ 835 | 🐛 59 | 🌐 Rust | 📅 2026-02-21 - A cross-platform font loading library.
...
* [freetype-rs](https://github.com/PistonDevelopers/freetype-rs) ⭐ 94 | 🐛 25 | 🌐 Rust | 📅 2025-01-08 - Rust bindings for FreeType library.
...
* [font\_awesome\_icons](https://github.com/janestreet/font_awesome_icons) ⭐ 0 | 🐛 0 | 🌐 OCaml | 📅 2026-07-10 - An OCaml library for Font-Awesome SVG icons.

## JavaScript

* [Web Font Loader](https://github.com/typekit/webfontloader) ⭐ 9,254 | 🐛 107 | 🌐 JavaScript | 📅 2024-01-04 - Gives you added control when using linked fonts via @font-face.
* [Fontello](https://github.com/fontello/fontello) ⭐ 7,082 | 🐛 66 | 🌐 JavaScript | 📅 2022-12-31 - This tool lets you combine icon webfonts for your own project.
* [fontmin](https://github.com/ecomfe/fontmin) ⭐ 6,207 | 🐛 64 | 🌐 JavaScript | 📅 2025-08-13 - Minify font seamlessly.
* [font-spider](https://github.com/aui/font-spider) ⭐ 5,144 | 🐛 81 | 🌐 JavaScript | 📅 2022-12-30 - Smart webfont compression and format conversion tool.
* [OpenType.js](https://github.com/nodebox/opentype.js) ⭐ 5,008 | 🐛 200 | 🌐 JavaScript | 📅 2026-08-08 - Read and write OpenType fonts.
* [Font Face Observer](https://github.com/bramstein/fontfaceobserver) ⭐ 4,335 | 🐛 10 | 🌐 JavaScript | 📅 2025-02-18 - Font load events, simple, small and efficient [fontfaceobserver.com](https://fontfaceobserver.com).
* [Typeset.js](https://github.com/davidmerfield/Typeset) ⭐ 2,679 | 🐛 20 | 🌐 JavaScript | 📅 2025-04-19 - HTML pre-processor for web typography (hanging punctuation, soft hyphen insertion, optical margin outdents, small-caps conversion and punctuation substitution).
* [GitHub Font Preview](https://github.com/Mottie/GitHub-userscripts/wiki/GitHub-font-preview) ⭐ 2,027 | 🐛 51 | 🌐 JavaScript | 📅 2024-07-07 - Adds a preview for fonts & glyphs on GitHub with OpenType.js.
* [Punycode.js](https://github.com/bestiejs/punycode.js) ⭐ 1,689 | 🐛 48 | 🌐 JavaScript | 📅 2024-04-18 - Robust Punycode converter that fully complies to RFC 3492 and RFC 5891.
* [fontkit](https://github.com/foliojs/fontkit) ⭐ 1,667 | 🐛 166 | 🌐 JavaScript | 📅 2024-08-14 - Advanced font engine for Node and the browser.
* [subfont](https://github.com/Munter/subfont) ⭐ 1,635 | 🐛 17 | 🌐 JavaScript | 📅 2026-03-21 - Command line tool to inject Google font subsets used glyphs into your page.
* [node-emoji](https://github.com/omnidan/node-emoji) ⭐ 1,342 | 🐛 17 | 🌐 TypeScript | 📅 2025-02-07 - 😏 simple emoji support for Node.js projects.
...
* [Typeset](https://github.com/bramstein/typeset) ⭐ 1,036 | 🐛 10 | 🌐 JavaScript | 📅 2026-06-20 - TeX line breaking algorithm in JavaScript.
* [Typr.js](https://github.com/photopea/Typr.js) ⭐ 1,001 | 🐛 10 | 🌐 JavaScript | 📅 2025-08-28 - Process fonts in JavaScript.
* [grapheme-splitter](https://github.com/orling/grapheme-splitter) ⭐ 985 | 🐛 9 | 🌐 JavaScript | 📅 2021-02-12 - JavaScipt library that breaks strings into their individual user-perceived characters.
* [localFont](https://github.com/jaicab/localFont) ⭐ 846 | 🐛 2 | 🌐 CSS | 📅 2016-02-19 - Implement localStorage web font caching in seconds.
...
* [Hyphenopoly.js](https://github.com/mnater/Hyphenopoly) ⭐ 733 | 🐛 5 | 🌐 TypeScript | 📅 2026-04-30 - JavaScript polyfill for client-side hyphenation.
...
* [Hypher](https://github.com/bramstein/hypher) ⭐ 583 | 🐛 6 | 🌐 JavaScript | 📅 2018-07-29 - Fast and small JavaScript hyphenation engine.
* [Brotli.js](https://github.com/foliojs/brotli.js) ⭐ 537 | 🐛 30 | 🌐 JavaScript | 📅 2024-05-14 - A JavaScript port of the Brotli compression algorithm, as used in WOFF2.
* [fonteditor-core](https://github.com/kekee000/fonteditor-core) ⭐ 385 | 🐛 21 | 🌐 JavaScript | 📅 2026-06-22 - Read, write, transform fonts in JavaScript.
* [ttf2woff](https://github.com/fontello/ttf2woff) ⭐ 359 | 🐛 2 | 🌐 JavaScript | 📅 2022-11-23 - Convert TTF to WOFF, for Node.js.
...
* [webfont](https://github.com/itgalaxy/webfont) ⭐ 308 | 🐛 17 | 🌐 TypeScript | 📅 2026-08-12 - Awesome generator of webfont, WOFF2, WOFF, EOT, TTF and SVG.
* [node-unicode-data](https://github.com/mathiasbynens/node-unicode-data) ⭐ 155 | 🐛 12 | 🌐 JavaScript | 📅 2026-06-13 - JavaScript-compatible Unicode data generator.
...
* [OpenType](https://github.com/bramstein/opentype) ⚠️ Archived - Font parser in JavaScript.
* [custom-fonts-in-emails](https://github.com/ladjs/custom-fonts-in-emails) ⭐ 132 | 🐛 0 | 🌐 JavaScript | 📅 2023-06-20 - Extremely easy way to use custom fonts in emails without having to use art software.
...
* [fontfacegen](https://github.com/agentk/fontfacegen) ⭐ 60 | 🐛 12 | 🌐 JavaScript | 📅 2026-08-10 - Browser font-face generator for creating browser usable fonts from TTF's or OTF's.
* [unicode-properties](https://github.com/foliojs/unicode-properties) ⭐ 59 | 🐛 7 | 🌐 JavaScript | 📅 2023-01-08 - Provides fast access to unicode character properties.
...
* [cubic2quad](https://github.com/fontello/cubic2quad) ⭐ 36 | 🐛 1 | 🌐 JavaScript | 📅 2023-12-27 - Approximates cubic bezier curves with quadratic ones.
...
* [svgfont2svgicons](https://github.com/nfroidure/svgfont2svgicons) ⭐ 16 | 🐛 6 | 🌐 TypeScript | 📅 2024-08-12 - Extract SVG icons from an SVG font.
* [font-toolkit](https://github.com/hsiaosiyuan0/fonts) ⭐ 16 | 🐛 14 | 🌐 TypeScript | 📅 2022-12-06 - Font file manipulating in TypeScript.
* [Minimal-font-generator](https://github.com/Pomax/Minimal-font-generator) ⭐ 14 | 🐛 0 | 🌐 HTML | 📅 2026-07-24 - Font's Hello world.
* [unicode-tr51-emoji](https://github.com/cameronhunter/unicode-tr51-emoji) ⭐ 14 | 🐛 33 | 🌐 JavaScript | 📅 2017-05-04 - Emoji data extracted from Unicode Technical Report #51 v1.0 – v5.0.
* [caryll / shapeops](https://github.com/caryll/shapeops) ⭐ 12 | 🐛 2 | 🌐 JavaScript | 📅 2017-12-01 - Boolean operations and overlap removal for curves.
* [node-fonttools](https://github.com/dfrankland/node-fonttools) ⭐ 10 | 🐛 4 | 🌐 C++ | 📅 2018-07-03 - Native bindings to fonttools to decompile and compile fonts.
...
* [CharacterMap](https://github.com/bluejamesbond/CharacterMap/) ⭐ 3 | 🐛 0 | 🌐 JavaScript | 📅 2022-11-17 - Online Character Map / Glyph / Icon / Font Viewer.
...
* [fontTools](https://github.com/fonttools/fonttools) ⭐ 5,203 | 🐛 424 | 🌐 Python | 📅 2026-08-12 - Library for manipulating fonts, written in Python.
* [fontmake](https://github.com/googlei18n/fontmake) ⭐ 884 | 🐛 270 | 🌐 Python | 📅 2026-07-22 - Compile fonts from sources (UFO, Glyphs) to binary (OpenType, TrueType).
* [Font Bakery](https://github.com/googlefonts/fontbakery) ⭐ 688 | 🐛 302 | 🌐 Python | 📅 2025-11-04 - Tools to prepare font families for inclusion in github.com/google/fonts.
* [pyftfeatfreeze](https://github.com/twardoch/fonttools-utils/tree/master/pyftfeatfreeze) ⭐ 483 | 🐛 19 | 🌐 Python | 📅 2026-07-05 - With pyftfeatfreeze, you can “freeze” some OpenType features into a font.
* [monospacifier.py](https://github.com/cpitclaudel/monospacifier) ⭐ 428 | 🐛 10 | 🌐 Python | 📅 2024-01-30 - Convert variable-pitch fonts to monospace (useful for unicode and indentation-friendly programming).
* [Noto Tools](https://github.com/googlei18n/nototools) ⭐ 303 | 🐛 99 | 🌐 Python | 📅 2026-08-03 - Noto fonts support tools and scripts.
...
* [font-line](https://github.com/source-foundry/font-line) ⭐ 202 | 🐛 5 | 🌐 Python | 📅 2023-05-11 - OpenType vertical metrics reporting and font line spacing adjustment tool.
...
* [pyfontaine](https://github.com/davelab6/pyfontaine) ⭐ 106 | 🐛 31 | 🌐 Python | 📅 2026-04-21 - Python tool to check font files for language/character set support.
...
* [Huerta Tipográfica Letterspacer](https://github.com/huertatipografica/HTLetterspacer) ⭐ 80 | 🐛 1 | 🌐 Python | 📅 2026-08-13 - HT Letterspacer is a tool for spacing fonts.
* [Kernagic](https://github.com/hodefoting/kernagic) ⭐ 76 | 🐛 7 | 🌐 C | 📅 2019-03-27 - Semi-automatic font spacing tool.
* [kern-dump](https://github.com/adobe-type-tools/kern-dump) ⭐ 71 | 🐛 2 | 🌐 Python | 📅 2024-05-03 - Scripts for working with and analyzing kerning information (ATypI 2013).
* [Glyph Nanny](https://github.com/typesupply/glyph-nanny) ⭐ 67 | 🐛 14 | 🌐 Python | 📅 2024-04-18 - Live report about potential drawing issues in your glyph.
...
* [emoji-extractor](https://github.com/tmm1/emoji-extractor) ⭐ 562 | 🐛 10 | 🌐 Ruby | 📅 2023-01-26 - Extracts high-resolution emoji pngs from Apple Color Emoji.ttf.
* [font](https://github.com/alyssais/font) ⚠️ Archived - Command-line font manager.

## Go

* [freetype](https://github.com/golang/freetype) ⚠️ Archived - Font rasterizer in Go.
* [font](https://github.com/ConradIrwin/font) ⭐ 77 | 🐛 0 | 🌐 Go | 📅 2026-02-02 - Parsing OpenType fonts in Golang.
* [checkfont](https://codeberg.org/lapingvino/checkfont) - Checks which system fonts contain the desired characters.

## PHP

* [PHP Font Lib](https://github.com/PhenX/php-font-lib) ⭐ 1,801 | 🐛 24 | 🌐 PHP | 📅 2026-01-20 - Library to read, parse, export and make subsets of different types of font files.
* [JoliTypo](https://github.com/jolicode/JoliTypo) ⭐ 349 | 🐛 14 | 🌐 PHP | 📅 2026-08-04 - Microtypography fixer for the web.
...
* [Fontastic](https://github.com/andreaskoller/Fontastic) ⭐ 110 | 🐛 3 | 🌐 Java | 📅 2013-06-19 - Processing library to create TrueType font files.

## Clojure

* [opentype.clj](https://github.com/ivarref/opentype.clj) ⭐ 2 | 🐛 0 | 🌐 JavaScript | 📅 2018-03-19 - A simple API over OpenType.js for Clojure. Runs on the JVM.

## UFO

[unifiedfontobject.org](http://unifiedfontobject.org)

* [ufo-spec](https://github.com/unified-font-object/ufo-spec) ⭐ 191 | 🐛 55 | 🌐 SCSS | 📅 2026-05-21 - The official Unified Font Object specification source files.
* [ufo2ft](https://github.com/googlei18n/ufo2ft) ⭐ 175 | 🐛 79 | 🌐 Python | 📅 2026-08-10 - UFO to FontTools.
* [ufoJS](https://github.com/graphicore/ufoJS) ⭐ 56 | 🐛 16 | 🌐 JavaScript | 📅 2016-05-19 - JavaScript API for the Unified Font Object.
* [ufoNormalizer](https://github.com/unified-font-object/ufoNormalizer) ⭐ 51 | 🐛 13 | 🌐 Python | 📅 2025-10-03 - Tool that will normalize the XML and other data inside of a UFO.
...
* [FontForge](https://github.com/fontforge/fontforge) ⭐ 7,893 | 🐛 1,028 | 🌐 C | 📅 2026-08-10 - Free (libre) font editor for Windows, macOS and GNU+Linux.
* [fonteditor](https://github.com/ecomfe/fonteditor) ⭐ 1,493 | 🐛 2 | 🌐 JavaScript | 📅 2025-07-15 - Web-based TTF font editor, live at [fontstore.baidu.com](http://fontstore.baidu.com/static/editor/index-en.html).
* [Birdfont](https://github.com/johanmattssonm/birdfont) ⭐ 550 | 🐛 79 | 🌐 Vala | 📅 2025-11-23 - Font editor which can generate fonts in TTF, EOT, SVG and BF format.
* [TruFont](https://github.com/trufont/trufont) ⭐ 504 | 🐛 95 | 🌐 Python | 📅 2025-12-02 - UFO3 font editor. À l’ancienne.
...
* [OpenType Sanitiser](https://github.com/khaledhosny/ots) ⭐ 307 | 🐛 18 | 🌐 C++ | 📅 2026-08-04 - The OpenType Sanitiser (OTS) parses and serialises OpenType files (OTF, TTF) and WOFF and WOFF2 font files, validating them and sanitising them as it goes.
...
* [Twitter Emoji (Twemoji)](https://github.com/twitter/twemoji) ⭐ 17,726 | 🐛 143 | 🌐 HTML | 📅 2026-07-07 - The Twemoji library offers support for +2k emojis, including skin tone and gender modifiers.
...
* [designwithfontforge.com](https://github.com/fontforge/designwithfontforge.com) ⭐ 1,038 | 🐛 61 | 🌐 HTML | 📅 2026-07-16 - Book about how to design new typefaces with FontForge. See [designwithfontforge.com](http://designwithfontforge.com).
...
* [homebrew-webfonttools](https://github.com/bramstein/homebrew-webfonttools) ⭐ 363 | 🐛 3 | 🌐 Ruby | 📅 2021-08-18 - Homebrew formulae for font tools.
...
* [AGL & AGLFN](https://github.com/adobe-type-tools/agl-aglfn) ⭐ 110 | 🐛 4 | 📅 2019-10-31 - AGL / AGLFN (Adobe Glyph List / For New Fonts) simply provides mappings from glyph names to Unicode scalar values. [See specification](https://github.com/adobe-type-tools/agl-specification) ⭐ 70 | 🐛 1 | 📅 2019-08-22.
...
* [The State of Web Type](https://github.com/bramstein/stateofwebtype) ⭐ 65 | 🐛 12 | 🌐 JavaScript | 📅 2017-11-18 - "Can I Use" for typography.
* [Type Facet](https://github.com/charlesmchen/typefacet) ⭐ 54 | 🐛 2 | 🌐 Python | 📅 2012-10-21 - Collection of Python scripts for working with fonts. See [TypeFacet Autokern](http://charlesmchen.github.io/typefacet/topics/autokern/index.html)
* [Kernall](https://github.com/n8willis/kernall) ⭐ 47 | 🐛 0 | 📅 2016-04-25 - Kerning and letterspacing research.
...
* [Alfred Special Characters](https://github.com/typefacts/alfred-special-characters) ⭐ 32 | 🐛 0 | 🌐 Python | 📅 2023-07-18 - Typefacts Special Characters Workflow for Alfred 3.
...
* [jenskutilek/TypoLabs2016](https://github.com/jenskutilek/TypoLabs2016) ⭐ 16 | 🐛 0 | 🌐 Python | 📅 2022-08-12 - Code examples from Jens Kutilek's TypoLabs workshop.
* [Type Tools dotfiles](https://github.com/benkiel/dotfiles) ⭐ 14 | 🐛 0 | 🌐 Shell | 📅 2019-09-03 - Setup for type tools.
...
* [Iosevka](https://github.com/be5invis/Iosevka) ⭐ 22,617 | 🐛 103 | 🌐 JavaScript | 📅 2026-08-13 - Slender typeface for code, from code.
* [Source Han Sans](https://github.com/adobe-fonts/source-han-sans) ⭐ 17,057 | 🐛 162 | 🌐 Python | 📅 2025-06-25 - Set of OpenType/CFF Pan-CJK fonts.
* [Source Han Serif](https://github.com/adobe-fonts/source-han-serif) ⭐ 9,613 | 🐛 74 | 🌐 Shell | 📅 2024-07-30 - Set of OpenType/CFF Pan-CJK fonts.
* [Hasklig](https://github.com/i-tu/Hasklig) ⭐ 5,721 | 🐛 44 | 🌐 Python | 📅 2022-02-19 - Code font with monospaced ligatures.
* [Noto Emoji](https://github.com/googlei18n/noto-emoji) ⭐ 4,879 | 🐛 106 | 🌐 Python | 📅 2025-09-15 - Color and Black-and-White Noto emoji fonts, and tools for working with them.
...
* [Overpass](https://github.com/RedHatBrand/Overpass) ⭐ 2,097 | 🐛 45 | 🌐 Makefile | 📅 2023-07-20 - Open source font family inspired by Highway Gothic.
* [Twitter Color Emoji Font](https://github.com/eosrei/twemoji-color-font) ⭐ 1,917 | 🐛 45 | 🌐 Makefile | 📅 2026-06-25 - Color emoji OpenType-SVG font using Twitter Unicode 9.0 emoji with diversity and country flags.
...
* [EmojiOne COLR/CPAL](https://github.com/mozilla/twemoji-colr) ⭐ 393 | 🐛 15 | 🌐 JavaScript | 📅 2024-03-28 - EmojiOne font in COLR/CPAL layered format.
* [Bungee](https://github.com/djrrb/Bungee/) ⭐ 375 | 🐛 9 | 🌐 Python | 📅 2026-02-01 - Chromatic signage typeface for vertical and horizontal setting.
...
* [Adobe Variable Font Prototype](https://github.com/adobe-fonts/adobe-variable-font-prototype) ⭐ 150 | 🐛 2 | 🌐 Python | 📅 2022-08-09 - Variable font example in OpenType-CFF2 & TrueType formats.
* [Microsoft open source fonts](https://github.com/Microsoft/fonts) ⭐ 142 | 🐛 9 | 📅 2022-11-28 - Central location to share Microsoft's open source fonts.
* [The Gilbert Font](https://github.com/Fontself/TypeWithPride) ⭐ 89 | 🐛 4 | 📅 2019-05-28 - OpenType-SVG font named after Gilbert Baker, the creator of the rainbow flag.
* [Adobe NotDef](https://github.com/adobe-fonts/adobe-notdef) ⭐ 82 | 🐛 0 | 🌐 PostScript | 📅 2019-12-03 - Maps 1,111,998 Unicode code points to 2,048 .notdef glyphs.
* [Adobe Fonts / Source Emoji](https://github.com/adobe-fonts/source-emoji) ⭐ 76 | 🐛 3 | 🌐 HTML | 📅 2025-10-28 - Source Emoji is an emoji font project that began development in order to provide monochrome representative glyphs to the Unicode Consortium for emoji candidates that have been accepted by the UTC (Unicode Technical Committee) but have not yet been fully ratified to become a part of the official standard.
* [Adobe Blank 2](https://github.com/adobe-fonts/adobe-blank-2) ⭐ 32 | 🐛 0 | 🌐 PostScript | 📅 2022-07-22 - Based on Adobe Blank, and differs mainly in that the number of glyphs has been reduced to only two, thanks to the Format 13 'cmap' subtable.
* [BuffaloGals](https://github.com/TrueTyper/BuffaloGals) ⭐ 29 | 🐛 0 | 📅 2017-04-19 - Buffalo Gals is one of the very first “Variable Fonts”, originally made in 1992 for an Apple TrueType GX developer CD.
...
* [Blackout](https://github.com/RoelN/Blackout) ⭐ 10 | 🐛 0 | 🌐 HTML | 📅 2017-04-10 - One font to blackout them all.
* [Freizer](https://github.com/xerographer/freizer-color-font) ⭐ 8 | 🐛 1 | 🌐 Makefile | 📅 2016-06-07 - OpenType-SVG color font.
* [null-ttf](https://github.com/grzegorzrolek/null-ttf) ⭐ 8 | 🐛 0 | 🌐 Makefile | 📅 2016-02-27 - This font is null. It's the smallest possible TrueType binary still valid on macOS and with most of its bytes wiped out.
...
For more, check [awesome-fonts](https://github.com/brabadu/awesome-fonts) ⭐ 2,045 | 🐛 8 | 📅 2026-07-26!
...
* [Tales of ⌧! Can You Tell Your Story When Your Character Is Undefined?! by Persa Zula](https://github.com/pzula/tales-of-notdef) ⭐ 3 | 🐛 0 | 🌐 Ruby | 📅 2018-06-01

## Contribute

➡️Pull request! (Or open an issue [here](https://github.com/Jolg42/awesome-typography/issues) ⭐ 1,527 | 🐛 10 | 📅 2026-05-28).
